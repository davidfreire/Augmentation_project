...
class FileDataGen(object):
    ...
    # Arguments
    aug_mode: augmentation mode. None is the classical Keras augmentation. Otherwise,
    albumentation modes defined in augment.py file can be considered: 
    IAAPerspective, ShiftScaleRotate, MediumAug and StrongAug.
